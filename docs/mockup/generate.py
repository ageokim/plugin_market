...
FILL = {
  ...
  '<div id="pluginList"></div>': '''<div id="pluginList">
          <div class="org-h"><svg class="ic"><use href="#i-org"/></svg><span>org-a</span> <span class="n">3개</span>
            <span class="sp"><button class="btn ghost sm" title="재스캔"><svg class="ic" style="width:12px;height:12px"><use href="#i-refresh"/></svg></button><button class="btn ghost sm" title="org 제거"><svg class="ic" style="width:12px;height:12px"><use href="#i-x"/></svg></button></span></div>
